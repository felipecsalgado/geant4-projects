...
void DetectorConstruction::DefineMaterials()
{
  ...
  new G4Material("F2glass", density= 3.61*g/cm3, ncomponents=6);
  LeadGlass->AddElement(Pb, fractionmass=42.2*perCent);
  LeadGlass->AddElement(Si, fractionmass=21.4*perCent);
  LeadGlass->AddElement(O, fractionmass=29.5*perCent);
  LeadGlass->AddElement(K, fractionmass=4.2*perCent);
  LeadGlass->AddElement(Na, fractionmass=2.3*perCent);
  LeadGlass->AddElement(As, fractionmass=0.4*perCent);
